...
require github.com/aws/aws-sdk-go-v2/feature/s3/transfermanager v0.1.3 // indirect
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/awss3exporter v0.146.0 // indirect
