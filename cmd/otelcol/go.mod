...
replace (
	...
	github.com/honeycombio/enhance-indexing-s3-exporter/index => ../../index
)
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/awss3exporter v0.160.0 // indirect
