...
require (
	github.com/honeycombio/enhance-indexing-s3-exporter/enhanceindexings3exporter v0.0.7
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/awss3exporter v0.139.0 // indirect
